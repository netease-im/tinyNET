 ...
 *
 * This file incude all your preferences or configuration. All specific
 configuration
 * must be defined in this file. You must include this file in all your header
 files.
 *
...
#define TNET_IANA_PEN                            \
    35368 /**< PEN number assigned by the IANA.  \
The list of assigned numbers could be found here \
http://www.iana.org/assignments/enterprise-numbers. */
#define TNET_RESOLV_CONF_PATH                       \
    "/etc/resolv.conf" /**< Path to "/resolv.conf". \
                        */
